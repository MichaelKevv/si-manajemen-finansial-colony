            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Gudang</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $gudang }}
                                    {{-- <span class="text-success text-sm font-weight-bolder"></span> --}}
                                </h5>
                        ...
                        <div class="col-4 text-end mb-4">
                            <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                                <i class="fas fa-warehouse text-lg opacity-10" aria-hidden="true"></i>
                            </div>
                        </div>
                        <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto"
                            href="{{ url('gudang') }}">
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Outlet</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $outlet }}
                                    {{-- <span class="text-success text-sm font-weight-bolder"></span> --}}
                                </h5>
            ...
            <div class="card z-index-2">
                <div class="card-body p-3">
                    <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                        <div class="chart">
                            <canvas id="chart-bars" class="chart-canvas" height="339"
                                style="display: block; box-sizing: border-box; height: 169.5px; width: 415.5px;"
                                width="831"></canvas>
                        </div>
                    </div>
                    <h6 class="ms-2 mt-4 mb-0">Pegawai Aktif</h6>
                        ...
                        <div class="row">
                            <div class="col-3 py-3 ps-0">
                                ...
                                <div class="progress w-75">
                                    <div class="progress-bar bg-dark w-{{ $admin }}" role="progressbar"
                                        aria-valuenow="{{ $admin }}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="col-3 py-3 ps-0">
                                <div class="d-flex mb-2">
                                ...
                                <h4 class="font-weight-bolder">{{ $kurir }}</h4>
                                <div class="progress w-75">
                                    <div class="progress-bar bg-dark w-{{ $kurir }}" role="progressbar"
                                        aria-valuenow="{{ $kurir }}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="col-3 py-3 ps-0">
                                <div class="d-flex mb-2">
                                    ...
                                    <p class="text-xs mt-1 mb-0 font-weight-bold">Kasir</p>
                                </div>
                                <h4 class="font-weight-bolder">{{ $kasir }}</h4>
                                <div class="progress w-75">
                                    <div class="progress-bar bg-dark w-{{ $kasir }}" role="progressbar"
                                        aria-valuenow="{{ $kasir }}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-7">
            <div class="card z-index-2">
                <div class="card-header pb-0">
                    <h6>Grafik Transaksi Tahun <span id="year-now"></span></h6>
                </div>
                <div class="card-body p-3">
                    <div class="chart">
...
@push('custom-scripts')
    <script>
        var label_trx = {{ Js::from($label_trx) }};
        var trx = {{ Js::from($trxs) }};

        var label_peg = {{ Js::from($label_peg) }};
        var pegawai = {{ Js::from($pegawais) }};
