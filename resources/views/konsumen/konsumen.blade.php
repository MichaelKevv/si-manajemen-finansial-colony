...
@section('content')
    ...
    <a target="_blank" href="{{ url('print-konsumen') }}">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-2">
                        <table class="table align-items-center mb-0 ">
                            ...
                            <tbody>
                                @foreach ($konsumen as $pgw)
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ url('storage/foto-konsumen/' . $pgw->foto) }}"
                                        ...
                                        <td class="align-middle">
                                            <form action="{{ route('konsumen.destroy', $pgw->id_konsumen) }}" method="POST">
                                                <a href="{{ route('konsumen.edit', $pgw->id_konsumen) }}"
