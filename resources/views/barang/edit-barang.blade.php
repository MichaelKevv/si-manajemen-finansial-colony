        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <form class="p-3" action="{{ route('barang.update', $barang->id_barang) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="id_kategori_barang" id="id_kategori_barang" required>
                                @foreach ($kategori as $k)
                                    <option
                                        {{ $k->id_kategori_barang == $kategoriSaatIni->id_kategori_barang ? 'selected' : '' }}
                                        value="{{ $k->id_kategori_barang }}">
                                        {{ $k->nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="id_gudang" id="id_gudang" required>
                                @foreach ($gudang as $g)
                                    <option {{ $g->id_gudang == $gudangSaatIni->id_gudang ? 'selected' : '' }}
                                        value="{{ $g->id_gudang }}">
                                        {{ $g->nama }}
                                    </option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="{{ $barang->nama }}" name="nama"
                                id="nama">
                        </div>
                        <div class="form-group">
                            <label for="harga" class="form-control-label">Harga</label>
                            <input class="form-control" type="number" value="{{ $barang->harga }}" name="harga"
                                id="harga">
                        </div>
                        <div class="form-group">
                            <label for="deskripsi" class="form-control-label">Deskripsi</label>
                            <textarea class="form-control" type="text" name="deskripsi" id="deskripsi">{{ $barang->nama }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="{{ $barang->status }}" name="status"
                                id="status">
                        </div>
                        <div class="form-group">
